    ...
    async def listen(self, ctx, *, url: str):
        ...
        try:
            ...
            if len(r.json()["data"]) < 1:
                await m.delete()
                return await ctx.send("<:twitch:404633403603025921> This user doesn't exist or is not currently streaming.")
            r = r.json()["data"][0]
            ...
            vc.play(player, after=lambda e: log.error("An audio player error occurred: " + e) if e else None)
